...
class Settings(BaseSettings):
    ...
    @property
    def REDIS_HOST(self):
        return {'TEST': self.TEST_REDIS_HOST, 'DEV': self.REDIS_HOST_, 'PROD': self.PROD_REDIS_HOST}[settings.MODE]
    
    @property
    def REDIS_PORT(self):
        return {'TEST': self.TEST_REDIS_PORT, 'DEV': self.REDIS_PORT_, 'PROD': self.PROD_REDIS_PORT}[settings.MODE]
