...
Revision ID: c31e093a969b
Revises: 
Create Date: 2025-10-21 22:27:26.873534
...
def upgrade() -> None:
    ...
    sa.Column('months_warranty', sa.Integer(), nullable=False),
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('query_text', sa.String(length=32), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], ondelete='CASCADE'),
    ...
    sa.Column('positive', sa.String(length=512), nullable=False),
    sa.Column('negative', sa.String(length=512), nullable=False),
