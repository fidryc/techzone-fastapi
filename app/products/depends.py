...
def get_product_service(
    session: SessionDep, product_dao: ProductDaoDep, category_dao: CategoryDaoDep
) -> ProductService:
...
HistoryQueryTextServiceDep = Annotated[
    HistoryQueryTextService, Depends(get_hqt_service)
]
