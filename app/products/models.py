...
class Product(Base):
    ...
    category_id: Mapped[int | None] = mapped_column(  # 🧩 исправлено: ondelete='SET NULL' требует nullable=True
...
class Review(Base):
    ...
    date_posted: Mapped[datetime | None] = mapped_column(default=datetime.now, nullable=True)
