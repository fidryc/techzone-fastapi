...
async def get_refresh_token_bl_service(session: SessionDep, refresh_token_bl_dao: RefreshTokenBLDaoDep) -> RefreshTokenBLService:
    return RefreshTokenBLService(session, refresh_token_bl_dao)

RefreshTokenBLServiceDep = Annotated[RefreshTokenBLService, Depends(get_refresh_token_bl_service)]
...
async def get_register_service(user_dao: UserDaoDep, redis_service: RedisServiceDep, session: SessionDep):
